...
import accountsRouter from './src/modules/accounts/accounts.routes.js';
...
app.use(
  cors({
    credentials: true,
    origin: ['http://localhost:4321', 'https://syncspend-project.onrender.com'],
  }),
);app.use(express.json());
app.use(cookieParser());

app.use('/api/auth', authRouter);
app.use('/api/accounts', authenticateUser, accountsRouter);
